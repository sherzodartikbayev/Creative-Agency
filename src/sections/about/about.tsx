...
const About = () => {
	return (
		<section id='about' className={`${styles.paddingX}`}>
			<div className='w-full mx-auto max-w-[1440px] pb-36'>
				...
				>
					...
					<div className='w-2/4 max-lg:w-full'>
						<p
							className={`${styles.desc} text-black dark:text-lightWhite mb-6`}
						>
						...
						<p
							className={`${styles.desc} text-black dark:text-lightWhite mb-6 max-ss:mb-9`}
						>
							We move with make a Creative Strategy for help your business goal,
							we help to improve your income by a services we have. make your
							content look interesting and make people look for your business
						...
						<div className='flex gap-6 max-lg:justify-center'>
							...
							<Button2 text='About Us' img={playCircle} />
						</div>
					</div>
				</div>
			</div>
